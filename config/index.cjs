...
const USER_CONFIG = {
  ...
  // 如果你非要填这里也行。脚本也能运行
  APP_ID: 'wx646c5b5153c5e81d',

  // 公众号APP_SECRET
  // 建议不要填这里，请使用文档中github secret的方法进行保密配置，保护您的隐私安全。
  // 如果你非要填这里也行。脚本也能运行
  APP_SECRET: 'f731772484a5cb3cda3c7cbce8337614',
  ...
  USERS: [
    {
      ...
      id: 'RwhugF2Kh56eQQhQjZrrcsOc1YFL2IDtKBDA6Wp1HGY	',
      // 你想对他发送的模板消息的模板ID
      useTemplateId: 'oB1QI6tbEpLxuOqB3qbMeLQURO7g',
      // 所在省份
      province: '云南',
      // 所在城市
      city: '昆明',
